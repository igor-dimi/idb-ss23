...
* $\textbf{\textttt{course}}(\underline{\textttt{id}}, \textttt{ title}, \textttt{ dept\_name} \rightarrow \textttt{ department}, \textttt{  credits})$
* $\textbf{\textttt{prereq}}(\underline{\textttt{course\_id} \rightarrow \textttt{ course}, \textttt{ prereq\_id} \rightarrow \textttt{ course}})$
* $\textbf{\textttt{department}}(\underline{\textttt{name}} , \textttt{ building, } \textttt{ budget})$
* $\textbf{\textttt{section}}(\underline{\textttt{course\_id}, \textttt{id}, \textttt{ semester}, \textttt{ year, }}(\textttt{building}, \textttt{ room\_number}) \rightarrow \textttt{classroom}, \textttt{ time\_slot\_id})$
* $\textbf{\textttt{teaches}}(\underline{\textttt{instructor\_ID}\rightarrow \textttt{ instructor}, (\textttt{ course\_id, sec\_id, semester, year}) \rightarrow \textttt{ section}})$
* $\textbf{\textttt{student}}(\underline{\textttt{ID}}, \textttt{ name}, \textttt{ dept\_name}\rightarrow \textttt{ department}, \textttt{ total\_credit})$
* $\textbf{\textttt{takes}}(\underline{\textttt{student\_ID} \rightarrow \textttt{student}, (\textttt{course\_id, section\_id, semester, year}) \rightarrow \textttt{section}}, \textttt{grade})$
* $\textbf{\textttt{advisor}}(\underline{\textttt{student\_id} \rightarrow \textttt{ student}, \textttt{ instructor\_id} \rightarrow \textttt{ instructor}})$
* $\textbf{\textttt{classroom}}(\underline{\textttt{building, room\_number}}, \textttt{ capacity})$
* $\textbf{\textttt{time\_slot}}(\underline{\textttt{id}, \textttt{  day}, \textttt{  start\_time}}, \textttt{ end\_time})$
